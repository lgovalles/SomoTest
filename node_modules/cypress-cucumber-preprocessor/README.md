...
```json
{
  "testFiles": "**/*.{login.feature,features}"
}
```
...
```shell
  ./node_modules/.bin/cypress-tags run -g 'cypress/integration/**/*.login.feature'
```

or 

```shell
  ./node_modules/.bin/cypress-tags run --glob 'cypress/integration/**/*.login.feature'
```
...
```shell
  ./node_modules/.bin/cypress-tags run -e GLOB='cypress/integration/**/*.login.feature'
```
